...
export const NarrativeOverlay: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-10 flex flex-col justify-between p-3 sm:p-12 md:p-16">
      ...
      <div 
        className="w-full text-center transition-opacity duration-75 pt-16 sm:pt-14 px-2 sm:px-0"
        style={{
          opacity: heroOpacity,
      ...
      >
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full glass-panel-gold border border-amber-500/40 mb-2 sm:mb-4 shadow-[0_0_20px_rgba(245,158,11,0.2)]">
        ...
        <div className="mt-3.5 sm:mt-8 flex flex-col items-center justify-center gap-1.5">
          ...
          <ChevronDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-amber-400/80 animate-bounce mt-0.5" aria-hidden="true" />
        </div>
      </div>
      ...
      <div 
        className="w-[calc(100%-1rem)] max-w-sm sm:max-w-md self-center sm:self-end text-right glass-panel-gold p-5 sm:p-8 rounded-xl sm:rounded-2xl shadow-[0_15px_40px_rgba(0,0,0,0.8)] border border-emerald-500/25 transition-all duration-75 pointer-events-auto"
        style={{
      ...
      >
        ...
        <button
          ...
          className="mt-3 sm:mt-4 text-xs font-mono text-emerald-300 hover:text-emerald-200 flex items-center gap-1 ml-auto transition-colors cursor-pointer"
        >
