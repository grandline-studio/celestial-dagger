...
export const NarrativeOverlay: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-10 flex flex-col justify-between p-6 sm:p-12 md:p-16">
      {/* 1. HERO TITLE (Top Center) */}
      <div 
        className="w-full text-center transition-opacity duration-75 pt-8 sm:pt-14"
        style={{
          opacity: heroOpacity,
      ...
      >
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full glass-panel-gold border border-amber-500/40 mb-4 shadow-[0_0_20px_rgba(245,158,11,0.2)]">
          <Sparkles className="w-3.5 h-3.5 text-amber-400" aria-hidden="true" />
          <span className="text-[11px] md:text-xs uppercase tracking-[0.35em] text-amber-200 font-semibold font-mono">
            ACT I &middot; THE HEAVENS
          </span>
        </div>
        <h1 className="text-4xl sm:text-6xl md:text-8xl font-black tracking-tight text-white font-serif drop-shadow-[0_4px_35px_rgba(0,0,0,0.9)] max-w-5xl mx-auto leading-none">
          FALL INTO THE <span className="gold-gradient-text">UNKNOWN.</span>
        </h1>
        <p className="mt-4 text-base sm:text-xl text-neutral-300 max-w-xl mx-auto font-light tracking-wide drop-shadow-md">
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-2">
          <div className="flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-black/40 border border-white/10 text-xs tracking-widest text-neutral-300 uppercase font-mono shadow-md backdrop-blur-sm">
            <span className="inline-block w-1.5 h-1.5 rounded-full bg-amber-400 animate-ping" aria-hidden="true" />
            Scroll to begin descent
          </div>
          <ChevronDown className="w-4 h-4 text-amber-400/80 animate-bounce mt-1" aria-hidden="true" />
        </div>
      </div>

      {/* 2. CARD 2: LEFT (0.32 -> 0.48) */}
      <div 
        className="max-w-md self-start text-left glass-panel-gold p-6 sm:p-8 rounded-2xl shadow-[0_15px_40px_rgba(0,0,0,0.8)] border border-cyan-500/25 transition-all duration-75 pointer-events-auto"
        style={{
      ...
      >
        <div className="flex items-center justify-between mb-3">
          <span className="text-[11px] uppercase tracking-[0.25em] text-cyan-400 font-semibold font-mono flex items-center gap-1.5">
            <Wind className="w-3.5 h-3.5" aria-hidden="true" />
            0.38 &middot; CLOUD CEILING
          </span>
          <span className="text-[10px] font-mono text-neutral-400 border border-white/10 px-2 py-0.5 rounded-full">
            10,400M ALT
          </span>
        </div>
        ...
        <button
          ...
          className="mt-4 text-xs font-mono text-cyan-300 hover:text-cyan-200 flex items-center gap-1 transition-colors cursor-pointer"
        >
      ...
      <div 
        className="max-w-md self-end text-right glass-panel-gold p-6 sm:p-8 rounded-2xl shadow-[0_15px_40px_rgba(0,0,0,0.8)] border border-emerald-500/25 transition-all duration-75 pointer-events-auto"
        style={{
      ...
      >
        <div className="flex items-center justify-between mb-3 flex-row-reverse">
          <span className="text-[11px] uppercase tracking-[0.25em] text-emerald-400 font-semibold font-mono flex items-center gap-1.5">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-white font-serif leading-tight">
          THE DEEPER YOU GO,<br />THE HEAVIER THE BLADE.
        </h2>
        <p className="mt-3 text-sm sm:text-base text-neutral-300 font-light leading-relaxed">
        ...
        <button
          ...
          className="mt-4 text-xs font-mono text-emerald-300 hover:text-emerald-200 flex items-center gap-1 ml-auto transition-colors cursor-pointer"
        >
      ...
      <div 
        className="max-w-md self-start text-left glass-panel-gold p-6 sm:p-8 rounded-2xl shadow-[0_15px_40px_rgba(0,0,0,0.8)] border border-amber-500/30 transition-all duration-75 pointer-events-auto"
        style={{
      ...
      >
        <div className="flex items-center justify-between mb-3">
          <span className="text-[11px] uppercase tracking-[0.25em] text-amber-400 font-semibold font-mono flex items-center gap-1.5">
            <Mountain className="w-3.5 h-3.5" aria-hidden="true" />
            0.68 &middot; MOUNTAIN VALLEY
          </span>
          <span className="text-[10px] font-mono text-amber-300/80 border border-amber-500/30 px-2 py-0.5 rounded-full">
            2,200M ALT
          </span>
        </div>
        <h2 className="text-2xl sm:text-3xl font-bold text-white font-serif leading-tight">
          UNTIL THERE IS<br />NOWHERE LEFT TO FALL.
        </h2>
        <p className="mt-3 text-sm sm:text-base text-neutral-300 font-light leading-relaxed">
      ...
      <div 
        className="max-w-lg mx-auto text-center glass-panel-gold p-6 sm:p-8 rounded-2xl border border-orange-500/40 shadow-[0_0_50px_rgba(249,115,22,0.25)] transition-all duration-75 mb-16"
        style={{
          opacity: card5Opacity,
          display: card5Opacity <= 0.01 ? 'none' : 'block'
        }}
      >
        <span className="text-xs uppercase tracking-[0.3em] text-orange-400 font-semibold font-mono mb-2 block">
          0.90 &middot; TERMINAL ACCELERATION
        </span>
        <h2 className="text-3xl sm:text-4xl font-bold text-white font-serif">
          BRACE FOR IMPACT
        </h2>
        <p className="mt-2 text-sm text-neutral-300 font-light">
